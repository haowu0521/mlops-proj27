...
Non-v2 retraining files should be considered old versions unless you explicitly need them for historical reference.
...
Training or retraining is successful if:
